...
export class TasksService {
  ...
  async deleteTask(column:Column_,param){
  ...
  async updateTask(column:Column_,param,taskDto:CreateTaskDto){
    const task=await this.getOneTask(column,param)
    ...
    return await this.tasksRepository.findOne({
      ...
      relations:{ 
        ...
        column:{project:{creater:true}}
      }
    })
  }
  

  async repozTask(column:Column_,param,body){
  ...
  async getTasksOfColumn(column:Column_){
  ...
  async getOneTask(column:Column_,param){
  ...
  private async CountTasks(column:Column_){
